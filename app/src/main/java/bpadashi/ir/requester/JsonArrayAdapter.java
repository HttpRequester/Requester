...
public class JsonArrayAdapter extends ArrayAdapter<ModelJson> {
    private final Context context;
    private final List<ModelJson> values;

    public JsonArrayAdapter(Context context, List<ModelJson> values) {
